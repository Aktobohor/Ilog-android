...
/**
 * {@link LocationListener} triggered by the operating system when a new location is available, after that {@link LocationPassiveGPSListener} or {@link LocationPassiveNetworkListener}
 * registered for location updates.
 */
public class LocationPassiveGPSListener implements LocationListener {

    /**
     * Method triggered when the location from the {@link LocationManager#PASSIVE_PROVIDER} provider is available.
