...
/**
 * Class that implements a {@link Runnable} that manages the data collection of the {@link it.unitn.disi.witmee.sensorlog.model.sensors.AC} event. The data
 * collection occurs through the {@link SensorListener} class.
 * They are registered/unregistered in this class and the data of type {@link it.unitn.disi.witmee.sensorlog.model.sensors.AC} and  event is generated in them.
 ...
 * @author Mattia Zeni
 */
public class SensorAccelerometerRunnable implements Runnable {

    private volatile boolean isStopped = false;
    private SensorManager mSensorManager = null;
    private SensorListener sensorListener = null;
    private static int SENSOR_ID = Sensor.TYPE_ACCELEROMETER;
    private Sensor sensor = null;
    private HandlerThread mSensorThread;
    private Handler mSensorHandler;

    /**
     * Method that starts the collection of the {@link it.unitn.disi.witmee.sensorlog.model.sensors.AC} events. It performs the following operations:
     * <ul>
    ...
    /**
     * Contains information about the status of the data collection for this {@link it.unitn.disi.witmee.sensorlog.model.sensors.AC} event
    ...
    /**
     * Method that stops the collection of the {@link it.unitn.disi.witmee.sensorlog.model.sensors.AC} events. It performs the following operations:
     * <ul>
